...
public class WebRenderer
{
     ...
     */
    public long createView(int width, int height, boolean transparent)
    {
        return ncreateView(rendererPointer, width, height, transparent);
    }
    ...
    private native long ncreateView(long pointer, int width, int height, boolean transparent);
